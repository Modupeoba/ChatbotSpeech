...
st.markdown("<h1 style = 'color: #416D19; text-align: center; font-family:Garamond '>ChatterVoice</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #A4CE95; text-align: center; font-family: Copperplate Gothic'> Built by OBAMUYI M.V. </h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('pngwing.com__12_-removebg-preview.png',width = 500, caption = 'I reply all your questions')
